      ...
      <section className="relative py-12 md:py-32 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-2xl md:text-6xl font-bold text-[#1E5FA8] mb-4 md:mb-6">
            Découvrez Nos <span className="bg-gradient-to-r from-[#3AA655] to-[#E6C34A] bg-clip-text text-transparent">Produits</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-3xl md:text-6xl font-bold text-[#1E5FA8] mb-6">
             Nos produits  <span className="bg-gradient-to-r from-[#3AA655] to-[#E6C34A] bg-clip-text text-transparent">complets</span>
            </h2>
            <p className="text-gray-700 mb-8 text-lg max-w-2xl mx-auto leading-relaxed">
              Découvrez notre gamme complète de produits adaptés à vos besoins
            </p>
          </div>
